...
pub enum VncEvent {
    ...
    /// Negotiated layout or resize result. Same-size updates preserve pixels.
    /// Never answer this announcement with an unconditional full refresh.
    DesktopUpdate(crate::DesktopUpdate),
